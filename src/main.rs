...
fn main() {
    ...
    while let Some(character) = chars.next() {
        match character {
            ...
            '0' => push_press_and_release(Key::Kp0, &mut events_to_send),
            '1' => push_press_and_release(Key::Kp1, &mut events_to_send),
            '2' => push_press_and_release(Key::Kp2, &mut events_to_send),
            '3' => push_press_and_release(Key::Kp3, &mut events_to_send),
            '4' => push_press_and_release(Key::Kp4, &mut events_to_send),
            '5' => push_press_and_release(Key::Kp5, &mut events_to_send),
            '6' => push_press_and_release(Key::Kp6, &mut events_to_send),
            '7' => push_press_and_release(Key::Kp7, &mut events_to_send),
            '8' => push_press_and_release(Key::Kp8, &mut events_to_send),
            '9' => push_press_and_release(Key::Kp9, &mut events_to_send),
